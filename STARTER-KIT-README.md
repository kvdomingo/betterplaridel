...
- **🌐 Multilingual Support**: English, Filipino, Bulacanano, and other Philippine languages
...
```yaml
name: 'Municipality of Plaridel'
type: 'City' # or "Municipality"
region: 'Region III'
province: 'Bulacan'
mayor: "Jocell Vistan-Casaje"
...
```markdown
# Service Title — Municipality of Plaridel
